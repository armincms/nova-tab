...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-tab-navigator', __webpack_require__(7));
    Vue.component('detail-tab-navigator', __webpack_require__(9));
    Vue.component('form-tab-navigator', __webpack_require__(17));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        tabNavigator: __webpack_require__(4)
    },
    data: function data() {
        return {
            components: {
    ...
    mounted: function mounted() {
        ...
        Nova.$on('tab-changed', function (tab) {
            _this.handleTabChanges(tab);
        });
    },

    methods: {
        handleTabChanges: function handleTabChanges(tab) {
            var last = null;
        ...
        walkThroughComponents: function walkThroughComponents(callback) {
        ...
        searchComponents: function searchComponents($vue) {
            var $this = this,
                $components = [];
  ...
  return _c(
    ...
    _vm._l(_vm.tabs, function(tab) {
      return _c(
        ...
        {
          staticClass:
            "remove-last-margin-bottom leading-normal py-4 px-8 text-center cursor-pointer font-bold",
          class: [
            _vm.current == tab.name ? "border-primary border-b-2 -mb-px" : "",
            _vm.fullwidth ? "w-full" : ""
          ],
          on: {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("tab-navigator", {
    attrs: { tabs: _vm.field.tabs, "full-width": _vm.field.fullwidth },
    on: { "tab-changed": _vm.handleTabChanges }
  })
}
var staticRenderFns = []
render._withStripped = true
